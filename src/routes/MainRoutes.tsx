...
const ReacttableTask = Loadable(lazy(() => import('pages/tables/react-table/tableTask')));
const ReacttableSecretCode = Loadable(lazy(() => import('pages/tables/react-table/tableSecretCode')));
const ReactTableUserMetrics = Loadable(lazy(() => import('pages/tables/react-table/tableUserMetrics')));
const ReactInviteFriends = Loadable(lazy(() => import('pages/tables/react-table/inviteFriends')));
const ReactleaderBoard = Loadable(lazy(() => import('pages/tables/react-table/leaderBoard')));
const ReactwalletBoard = Loadable(lazy(() => import('pages/tables/react-table/walletBoard')));
const ReactdailyLogin = Loadable(lazy(() => import('pages/tables/react-table/dailyLogin')));
const ReactMissionTask = Loadable(lazy(() => import('pages/tables/react-table/missionTask')));
const ReactdailyBooster = Loadable(lazy(() => import('pages/tables/react-table/dailyBooster')));
const ReactUserManage = Loadable(lazy(() => import('pages/tables/react-table/userManage')));
          ...
          children: [
            {
              ...
              children: [
                ...
                {
                  path: 'Task',
                  element: <ReacttableTask />
                },
                {
                  path: 'SecretCode',
                  element: <ReacttableSecretCode />
                },
                {
                  path: 'UserMetrics',
                  element: <ReactTableUserMetrics />
                },
                {
                  path: 'leaderBoard',
                  element: <ReactleaderBoard />
                },
                {
                  path: 'walletBoard',
                  element: <ReactwalletBoard />
                },
                
                {
                  path: 'inviteFriends',
                  element: <ReactInviteFriends />
                },
                {
                  path: 'dailyLogin',
                  element: <ReactdailyLogin />
                },
                {
                  path: 'missionTask',
                  element: <ReactMissionTask />
                },
                {
                  path: 'dailyBooster',
                  element: <ReactdailyBooster />
                },
