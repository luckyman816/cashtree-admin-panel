...
const menuItems: NavItemType[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'Task',
        search: 'Task, table Task',
        title: <FormattedMessage id="Task" />,
        type: 'item',
        url: '/components-overview/Task'
      },
      {
        id: 'SecretCode',
        search: 'SecretCode, table SecretCode',
        title: <FormattedMessage id="SecretCode" />,
        type: 'item',
        url: '/components-overview/SecretCode'
      },
      {
        id: 'UserMetrics',
        search: 'UserMetrics, table UserMetrics',
        title: <FormattedMessage id="UserMetrics" />,
        type: 'item',
        url: '/components-overview/UserMetrics'
      },
      {
        id: 'leaderBoard',
        search: 'leaderBoard, table leaderBoard',
        title: <FormattedMessage id="leaderBoard" />,
        type: 'item',
        url: '/components-overview/leaderBoard'
      },
      {
        id: 'walletBoard',
        search: 'walletBoard, table walletBoard',
        title: <FormattedMessage id="walletBoard" />,
        type: 'item',
        url: '/components-overview/walletBoard'
      },
      
      {
        id: 'inviteFriends',
        search: 'inviteFriends, table inviteFriends',
        title: <FormattedMessage id="inviteFriends" />,
        type: 'item',
        url: '/components-overview/inviteFriends'
      },
      {
        id: 'dailyLogin',
        search: 'dailyLogin, table dailyLogin',
        title: <FormattedMessage id="dailyLogin" />,
        type: 'item',
        url: '/components-overview/dailyLogin'
      },
      {
        id: 'missionTask',
        search: 'missionTask, table missionTask',
        title: <FormattedMessage id="missionTask" />,
        type: 'item',
        url: '/components-overview/missionTask'
      },
      {
        id: 'dailyBooster',
        search: 'dailyBooster, table dailyBooster',
        title: <FormattedMessage id="dailyBooster" />,
        type: 'item',
        url: '/components-overview/dailyBooster'
      },
      {
        id: 'userManage',
        search: 'userManage, table userManage',
        title: <FormattedMessage id="userManage" />,
        type: 'item',
        url: '/components-overview/userManage'
      },
      {
        id: 'pagination',
        search: 'pagination, table pagination',
